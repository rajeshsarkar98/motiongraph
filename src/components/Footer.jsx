...
import "../styles/Footer.css"; // We'll add CSS below
...
const footerSections = [
  {
    ...
    links: [
      "Guidelines",
      "Terms and Conditions for Payment and Work",
      "Payment",
      "Wedding Booking",
      "Children Photography Enquiry",
      "Careers",
    ],
  },
  {
    ...
    links: [
      ...
      "Prewedding Short Films",
      "Wedding Films",
      "Baby Cinematic Video",
  ...
  return (
    <div className="bg-black bg-opacity-75 ">
      <footer className="py-5">
        <div className="row justify-content-center text-center">
          {footerSections.map((section, idx) => (
            <div className="col-12 col-md-3 mb-4" key={idx}>
              <h5 className="text-white fs-4 ">{section.title}</h5>
              <ul className="nav flex-column">
                {section.links.map((link, linkIdx) => (
                  <li className="nav-item mb-2" key={linkIdx}>
                    <a href="#" className="text-white opacity-75 nav-link p-0 footer-link">
                      {link}
                    </a>
                  </li>
                ))}
        ...
        <div className="d-flex flex-column align-items-center justify-content-center py-5 my-4 border-top text-white text-center">
          <p>
            © 2025 Motion Graph. All rights reserved. | Established 2020 | Contact with Developer
          </p>
          <ul className="list-unstyled d-flex">
            ...
            <li className="ms-3">
              <a className="link-body-emphasis" href="#" aria-label="Whatapp">
            ...
            <li className="ms-3">
              <a className="link-body-emphasis" href="#" aria-label="Youtube">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-youtube text-white" viewBox="0 0 16 16">
